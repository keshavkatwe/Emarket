            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            <a href="#">
                                <i class="fa fa-plus"></i> <span>Manage Recipe</span> <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="#"><i class="fa fa-circle-o"></i> Add Recipe</a></li>
                                <li><a href="#"><i class="fa fa-circle-o"></i> My Recipe</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
